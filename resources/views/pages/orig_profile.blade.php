        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <span class="badge badge-primary form-badge">{{$user->id}}</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="example-search-input" class="col-sm-2 col-form-label">Username <span>*</span></label>
                        <div class="col-sm-10">
                            <span class="badge badge-primary form-badge">{{$user->name}}</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="checkboxContainer">
                                ...
                                <label for="primary_Family" class="font-13 text-muted checkboxLabel">This email is being used by other people (siblings/family) as well. </label for="">
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="checkboxContainer">
                                ...
                                <label for="alternate_Family" class="font-13 text-muted checkboxLabel">This email is being used by other people (siblings/family) as well. </label>
                            </span>
            ...
            <div class="card m-t-40">
                <div class="card-body">
                    ...
                    <p class="text-muted m-b-30 font-14">I sing and/or play...</p>
