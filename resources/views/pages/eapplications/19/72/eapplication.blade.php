                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <div>
                                @if($errors->any())
                                    <div style="background-color: rgba(255,0,0,.1); border: 1px solid darkred; margin-bottom: .5rem;">
                                        <ul id="errors">
                                                ...
                                                <div class="list">
                                                    <ol>
                                                        ...
                                                        <li>
                                                            ...
                                                            in advance.  Once auditions have been closed, they will not be re-opened
                                                            for late-comers.
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            A complete schedule of rehearsal dates is posted on the All-Shore
                                                            Chorus web site.
                                                        </li>
                                                        <li>
