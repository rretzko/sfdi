        ...
        <form wire:submit.prevent="store" method="POST" class="form-horizontal m-t-20">
                        ...
                        <div class="row">
                            ...
                            @if($teachers && count($teachers))
                                <div style="display: flex; flex-direction: column; font-size: .8rem; padding: 1rem;">
                                    ...
                                    @empty
                                    @endforelse
                                    <div style="color: darkred; margin-top: 0.5rem; font-style: italic;">
                                        A teacher's name must be selected to continue...
                                    </div>
                                </div>
                            @endif
                        </div>
            ...
            @if($teacheruserid)
                ...
                <div class="form-group text-center row m-t-20">
                    ...
                    {{--
                        <div style="background-color: rgba(255,0,0,0.1); color: darkred; font-size: 1rem; padding: 0 0.5rem; margin: auto;">
                            A teacher must be selected.
                        </div>
                    --}}
                </div>
            @endif
