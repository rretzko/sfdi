<div id="tdr_form">
                ...
                @if($eventversion->id === 73) {{-- MORRIS AREA HONOR CHOIRS --}}
                    <div  style="margin-top: 1rem; width: 12rem;">
                        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank" >
                            ...
                            <input type="hidden" name="custom" value="{{ auth()->id().'*'.$registrant->id.'*'.$eventversion->id.'*'.$registrant->school()->id.'*15.00' }}" >
    ...
    <!-- BEGIN PITCH FILES -->
    <div class="text-black" style="margin-top: 1rem;border: 1px solid darkgrey; padding: .5rem; text-align: center;">
        <button class="btn btn-primary waves-effect waves-light">
            @if($eventversion->id === 69) {{-- NJ ALl-Shore Chorus 2021-22 --}}
