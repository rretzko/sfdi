<div id="tdr_form">
    <a href="{{ route('registrant.show', ['registrant' => $registrant->auditionnumber]) }}"
    ...
    @if(isset($registrant))
        ...
        @else <!-- used for demo purposes only -->
            ...
            <!-- UNUSED/HIDDEN VALUES -->
                                ...
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <label class="col-12">
                                        <ul>
                                            ...
                                            <li>I am current enrolled in Grade <b>{{ $registrant->student->gradeClassOf }}</b> at <b>{{ $registrant->student->activeSchool->name }}</b>.</li>
                                        </ul>
                                    </label>
                                    <div class="col-12">
                                        <input type="checkbox" name="eligibility" id="eligibility" value="1"
                                               @if(old('eligibility') && (old('eligibility') == 1)) CHECKED @endif
                                               @if($registrant->eapplication->eligibility == 1) CHECKED DISABLED @endif
                                ...
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <div class="col-12">
                                        <input type="checkbox" name="rulesandregs" id="rulesandregs" value="1"
                                               ...
                                               @if($registrant->eapplication->rulesandregs == 1) CHECKED @endif
                                               DISABLED >
                                    ...
                                    <div class="col-12">
                                        <div>
                                            <input type="radio" name="imageuse" id="imageuse" value="1"
                                                   ...
                                                   @if($registrant->eapplication->imageuse == 1) CHECKED @endif
                                                   DISABLED >
                                        ...
                                        <div>
                                            <input type="radio" name="imageuse" id="imageuse" value="-1"
                                                   @if(old('imageuse') && (old('imageuse') == -1)) CHECKED @endif
                                                   @if($registrant->eapplication->imageuse == -1) CHECKED DISABLED @endif
                                            >
                                    ...
                                    <div class="col-12">
                                        <div>
                                            <input type="radio" name="videouse" id="videouse" value="1"
                                                   ...
                                                   @if($registrant->eapplication->videouse == 1) CHECKED @endif
                                                   DISABLED >
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <label>I DO NOT allow my video to be used in production. Please ONLY use the audio portion of my submission.</label>
                                        </div>
                                        @error('videouse')
                        ...
                        <div class="form-group row">
                            <div class="col-11 ml-2 d-flex row">
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <label class="col-12">
                                        <h4>Rehearsals: February 13th, 20th, 27th, 2-3pm</h4>
                                        <ul>
                                    ...
                                    <div class="col-12">
                                        <input type="checkbox" name="absences" id="absences" value="1"
                                               ...
                                               @if($registrant->eapplication->absences == 1) CHECKED @endif
                                               DISABLED >
                        ...
                        <div class="form-group row">
                            <div class="col-11 ml-2 d-flex row">
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="input_signature" name="signaturestudent" id="signaturestudent" value="{{ old('signaturestudent', ($registrant->eapplication->signaturestudent ?: '')) }}" DISABLED >
                                ...
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <div class="col-12">
                                        <input type="checkbox" name="parentread" id="parentread" value="1"
                                               ...
                                               @if($registrant->eapplication->parentread) CHECKED @endif
                                               DISABLED >
                        ...
                        <div class="form-group row">
                            <div class="col-11 ml-2 d-flex row">
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="input_signature" name="signatureparent" id="signatureparent"
                                               value="{{ old('signatureparent', ($registrant->eapplication->signatureparent ?: '')) }}"
                                               DISABLED >
                                ...
                                <div class="col-11 ml-2 d-flex row">
                                    ...
                                    <div class="col-12">
                                        <input type="checkbox" name="courtesy" id="courtesy" value="1"
                                               ...
                                               @if($registrant->eapplication->courtesy == 1) CHECKED @endif
                                               DISABLED >
                        ...
                        <div class="form-group row">
                            <div class="col-11 ml-2 d-flex row">
                                <div class="col-11 ml-2 d-flex row">
                                    <h6>Dates</h6>
                                    <label class="col-12">
                                        <p>Completed on: <b>{{ $registrant->eapplication->created_at }}</b></p>
                                        <p>Updated on: <b>{{ $registrant->eapplication->updated_at }}</b></p>
                                        <p>Last updated by: <b>{{ $person->fullNameAlpha }}</b></p>
                                    </label>
                ...
                <div>
                    <a href="{{ route('pdf.application', ['registrant' => $registrant]) }}" title="Print {{ $registrant->student->person->fullName }} eApplication">
                        Print eApplication
                    </a>
                </div>
